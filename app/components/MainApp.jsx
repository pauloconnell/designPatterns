      ...
      <div id="divOne">
        ...
        <center>
          ...
          <div className="green">
            ...
            object creation compared to a basic approach. The basic form of
            object creation could result in design problems or in added
            complexity to the design. Creational design patterns solve this
            problem by somehow controlling object creation. Some of the popular
            design patterns in this category are: <br />
            Factory method
            <br /> Abstract
            <br /> factory
            <br /> Builder
          ...
          <div className="orange">
            ...
            These patterns deal with object relationships. They ensure that if
            one part of a system changes, the entire system doesn’t need to
            change along with it. The most popular patterns in this category
            are: <br />
            Adapter Bridge
            <br /> Composite
            <br /> Decorator
          ...
          <div className="blue">
            ...
            communication between disparate objects in a system. They help
            ensure that disparate parts of a system have synchronized
            information. Popular examples of these patterns are: <br />
          ...
          <div className="orange">
            ...
            Design patterns which are used for architectural purposes. Some of
            the most famous ones are: <br />
